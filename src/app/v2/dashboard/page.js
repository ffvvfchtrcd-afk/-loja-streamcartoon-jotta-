...
function calcStats(all) {
  ...
  const wins = all.filter(o => o.tipo.startsWith('win')).length
  ...
  for (const o of [...all].sort((a, b) => new Date(a.data || a.createdAt) - new Date(b.data || b.createdAt))) {
    ...
    else if (o.tipo.startsWith('win')) { curWin++; curLoss = 0; if (curWin > maxWinStreak) maxWinStreak = curWin }
  }
  return { total, wins, loss, winRate, lucroSemanal, lucroMensal, maxWinStreak, maxLossStreak }
}
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        ...
        <div className="card-cartoon p-4 text-center">
          ...
          <p className="text-[10px] text-gray-500">Total de wins</p>
        </div>
        <div className="card-cartoon p-4 text-center">
